...
func (db *StandardDatabase) initObjects() {
	...
	obj.AddProperty(newStandardProperty(0x85, "Measured cumulative power consumption", "number", 0, "optional", "notApplicable", "optional"))
	...
	obj.AddProperty(newStandardProperty(0x89, "Fault description", "raw", 0, "optional", "notApplicable", "optional"))
	...
	obj.AddProperty(newStandardProperty(0x93, "Remote controll setting", "state", 1, "optional", "optional", "optional"))
	...
	obj.AddProperty(newStandardProperty(0xC9, "Manufacture date of the device to be controlled", "date", 0, "optional", "notApplicable", "optional"))
	obj.AddProperty(newStandardProperty(0xCA, "Registerd information renewal date of the device to be controlled", "date", 0, "optional", "notApplicable", "optional"))
	obj.AddProperty(newStandardProperty(0xCA, "Registerd information renewal date of the device to be controlled", "date", 0, "optional", "notApplicable", "optional"))
	obj.AddProperty(newStandardProperty(0xCB, "Registerd information renewal version information of the device to be controlled", "number", 0, "optional", "notApplicable", "optional"))
	obj.AddProperty(newStandardProperty(0xCB, "Registerd information renewal version information of the device to be controlled", "number", 0, "optional", "notApplicable", "optional"))
